...
const Checkbox = (props) => { // constante con el mismo nombre de Componente Checkbox
    const {
        onChange,
        data: { id, description, done },//Propiedades checkbox, id, description, done
    } = props;
    return (
        <Fragment>
            {/* Just ADD !!!! */}
            <svg                   //SVG agregando una animacion e icons al check
                viewBox="0 0 0 0"
